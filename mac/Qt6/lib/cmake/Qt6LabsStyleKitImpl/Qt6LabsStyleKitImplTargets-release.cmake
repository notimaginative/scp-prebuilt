...
set_target_properties(Qt6::LabsStyleKitImpl PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6LabsStyleKitImpl.6.11.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libQt6LabsStyleKitImpl.6.dylib"
  )

list(APPEND _cmake_import_check_targets Qt6::LabsStyleKitImpl )
list(APPEND _cmake_import_check_files_for_Qt6::LabsStyleKitImpl "${_IMPORT_PREFIX}/lib/libQt6LabsStyleKitImpl.6.11.1.dylib" )
