...
set_target_properties(Qt6::QmlLocalStorage PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6QmlLocalStorage.6.11.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libQt6QmlLocalStorage.6.dylib"
  )

list(APPEND _cmake_import_check_targets Qt6::QmlLocalStorage )
list(APPEND _cmake_import_check_files_for_Qt6::QmlLocalStorage "${_IMPORT_PREFIX}/lib/libQt6QmlLocalStorage.6.11.1.dylib" )
