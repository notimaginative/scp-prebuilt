...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6ChartsPrivateTargetsPrecheck.cmake")

if(NOT __qt_ChartsPrivate_skip_include_targets_file AND Qt6ChartsPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6ChartsPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_ChartsPrivate_targets_file_included ON)
endif()
...
if(TARGET Qt6::ChartsPrivate)
    ...
    if(NOT DEFINED Qt6ChartsPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_ChartsPrivate_skip_include_targets_file)
            string(APPEND Qt6ChartsPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_ChartsPrivate_skip_include_targets_file being set to TRUE and thus "
