...
set(__qt_QuickTools_should_include_targets_code "TRUE")

# Do the checks inside Targets.cmake even when the file is still being generated
if(__qt_QuickTools_should_include_targets_code)
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickToolsTargetsPrecheck.cmake")
endif()

if(NOT __qt_QuickTools_skip_include_targets_file
        AND Qt6QuickTools_FOUND
        AND __qt_QuickTools_should_include_targets_code
    )
    ...
    set(__qt_QuickTools_targets_file_included ON)
endif()

set(__qt_QuickTools_extra_cmake_includes "Qt6SvgToQmlMacros.cmake")
foreach(extra_cmake_include IN LISTS __qt_QuickTools_extra_cmake_includes)
    include("${CMAKE_CURRENT_LIST_DIR}/${extra_cmake_include}")
endforeach()


if(__qt_QuickTools_targets_file_included AND Qt6QuickTools_FOUND)
