...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6AxServerTargetsPrecheck.cmake")

if(NOT __qt_AxServer_skip_include_targets_file AND Qt6AxServer_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6AxServerExtraProperties.cmake"
        OPTIONAL)
    set(__qt_AxServer_targets_file_included ON)
endif()
...
if (Qt6AxServer_FOUND
    ...
    find_package(Qt6AxServerPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_AxServer_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::AxServer)
    ...
    if(NOT DEFINED Qt6AxServer_NOT_FOUND_MESSAGE)
        ...
        if(__qt_AxServer_skip_include_targets_file)
            string(APPEND Qt6AxServer_NOT_FOUND_MESSAGE
                "Possibly due to __qt_AxServer_skip_include_targets_file being set to TRUE and thus "
