...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6AxContainerTargetsPrecheck.cmake")

if(NOT __qt_AxContainer_skip_include_targets_file AND Qt6AxContainer_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6AxContainerExtraProperties.cmake"
        OPTIONAL)
    set(__qt_AxContainer_targets_file_included ON)
endif()
...
if (Qt6AxContainer_FOUND
    ...
    find_package(Qt6AxContainerPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_AxContainer_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::AxContainer)
    ...
    if(NOT DEFINED Qt6AxContainer_NOT_FOUND_MESSAGE)
        ...
        if(__qt_AxContainer_skip_include_targets_file)
            string(APPEND Qt6AxContainer_NOT_FOUND_MESSAGE
                "Possibly due to __qt_AxContainer_skip_include_targets_file being set to TRUE and thus "
