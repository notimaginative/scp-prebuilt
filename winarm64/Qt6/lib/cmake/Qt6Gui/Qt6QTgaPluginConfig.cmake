...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QTgaPluginTargetsPrecheck.cmake")

if(NOT __qt_QTgaPlugin_skip_include_targets_file)
    ...
    if(QTgaPlugin_FOUND)
        ...
        set(__qt_QTgaPlugin_targets_file_included ON)
    endif()
endif()
