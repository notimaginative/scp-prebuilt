...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6SpatialAudioTargetsPrecheck.cmake")

if(NOT __qt_SpatialAudio_skip_include_targets_file AND Qt6SpatialAudio_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6SpatialAudioExtraProperties.cmake"
        OPTIONAL)
    set(__qt_SpatialAudio_targets_file_included ON)
endif()
...
if (Qt6SpatialAudio_FOUND
    ...
    find_package(Qt6SpatialAudioPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_SpatialAudio_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::SpatialAudio)
    ...
    foreach(extra_cmake_include Qt6SpatialAudioTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6SpatialAudio_NOT_FOUND_MESSAGE)
        ...
        if(__qt_SpatialAudio_skip_include_targets_file)
            string(APPEND Qt6SpatialAudio_NOT_FOUND_MESSAGE
                "Possibly due to __qt_SpatialAudio_skip_include_targets_file being set to TRUE and thus "
