...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6RemoteObjectsTargetsPrecheck.cmake")

if(NOT __qt_RemoteObjects_skip_include_targets_file AND Qt6RemoteObjects_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6RemoteObjectsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_RemoteObjects_targets_file_included ON)
endif()
...
if (Qt6RemoteObjects_FOUND
    ...
    find_package(Qt6RemoteObjectsPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_RemoteObjects_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::RemoteObjects)
    ...
    foreach(extra_cmake_include Qt6RemoteObjectsMacros.cmake;Qt6RemoteObjectsTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6RemoteObjects_NOT_FOUND_MESSAGE)
        ...
        if(__qt_RemoteObjects_skip_include_targets_file)
            string(APPEND Qt6RemoteObjects_NOT_FOUND_MESSAGE
                "Possibly due to __qt_RemoteObjects_skip_include_targets_file being set to TRUE and thus "
