...
set_target_properties(Qt6::QmlWorkerScript PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6QmlWorkerScript.so.6.11.1"
  IMPORTED_SONAME_RELEASE "libQt6QmlWorkerScript.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::QmlWorkerScript )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::QmlWorkerScript "${_IMPORT_PREFIX}/lib/libQt6QmlWorkerScript.so.6.11.1" )
