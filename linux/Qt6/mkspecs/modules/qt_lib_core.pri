...
QT.core.enabled_features = clock-monotonic cxx11_future cxx17_filesystem inotify std-atomic64 mimetype sharedmemory shortcut systemsemaphore xmlstream xmlstreamreader xmlstreamwriter textdate datestring process processenvironment temporaryfile library settings filesystemwatcher filesystemiterator itemmodel proxymodel sortfilterproxymodel identityproxymodel transposeproxymodel concatenatetablesproxymodel stringlistmodel translation easingcurve animation gestures jalalicalendar islamiccivilcalendar timezone commandlineparser cborstreamreader cborstreamwriter permissions threadsafe-cloexec version_tagging shared pkg-config rpath reduce_relocations signaling_nan thread future concurrent dbus test_gui test_squish shared intelcet glibc_fortify_source stack_protector stack_clash_protection libstdcpp_assertions relro_now_linker shared rpath reduce_exports reduce_relocations
QT.core.disabled_features = glib jemalloc cpp-winrt timezone_tzdb static cross_compile debug_and_release separate_debug_info appstore-compliant simulator_and_device force_asserts framework c++20 c++2a c++2b c++2c wasm-simd128 wasm-exceptions wasm-jspi zstd openssl-linked opensslv11 opensslv30
