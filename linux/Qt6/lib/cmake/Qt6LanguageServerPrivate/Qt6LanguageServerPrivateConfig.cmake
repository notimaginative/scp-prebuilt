...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6LanguageServerPrivateTargetsPrecheck.cmake")

if(NOT __qt_LanguageServerPrivate_skip_include_targets_file AND Qt6LanguageServerPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6LanguageServerPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_LanguageServerPrivate_targets_file_included ON)
endif()
...
if (Qt6LanguageServerPrivate_FOUND
    ...
    find_package(Qt6LanguageServerPrivatePrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_LanguageServerPrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::LanguageServerPrivate)
    ...
    foreach(extra_cmake_include Qt6LanguageServerPrivateTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6LanguageServerPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_LanguageServerPrivate_skip_include_targets_file)
            string(APPEND Qt6LanguageServerPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_LanguageServerPrivate_skip_include_targets_file being set to TRUE and thus "
