...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6RemoteObjectsQmlTargetsPrecheck.cmake")

if(NOT __qt_RemoteObjectsQml_skip_include_targets_file AND Qt6RemoteObjectsQml_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6RemoteObjectsQmlExtraProperties.cmake"
        OPTIONAL)
    set(__qt_RemoteObjectsQml_targets_file_included ON)
endif()
...
if (Qt6RemoteObjectsQml_FOUND
    ...
    find_package(Qt6RemoteObjectsQmlPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_RemoteObjectsQml_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::RemoteObjectsQml)
    ...
    foreach(extra_cmake_include Qt6RemoteObjectsQmlTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6RemoteObjectsQml_NOT_FOUND_MESSAGE)
        ...
        if(__qt_RemoteObjectsQml_skip_include_targets_file)
            string(APPEND Qt6RemoteObjectsQml_NOT_FOUND_MESSAGE
                "Possibly due to __qt_RemoteObjectsQml_skip_include_targets_file being set to TRUE and thus "
