...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6MultimediaQuickPrivateTargetsPrecheck.cmake")

if(NOT __qt_MultimediaQuickPrivate_skip_include_targets_file AND Qt6MultimediaQuickPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6MultimediaQuickPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_MultimediaQuickPrivate_targets_file_included ON)
endif()
...
if (Qt6MultimediaQuickPrivate_FOUND
    ...
    find_package(Qt6MultimediaQuickPrivatePrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_MultimediaQuickPrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::MultimediaQuickPrivate)
    ...
    foreach(extra_cmake_include Qt6MultimediaQuickPrivateTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6MultimediaQuickPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_MultimediaQuickPrivate_skip_include_targets_file)
            string(APPEND Qt6MultimediaQuickPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_MultimediaQuickPrivate_skip_include_targets_file being set to TRUE and thus "
