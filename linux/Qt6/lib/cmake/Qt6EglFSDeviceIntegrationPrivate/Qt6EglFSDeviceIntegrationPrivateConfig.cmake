...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6EglFSDeviceIntegrationPrivateTargetsPrecheck.cmake")

if(NOT __qt_EglFSDeviceIntegrationPrivate_skip_include_targets_file AND Qt6EglFSDeviceIntegrationPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6EglFSDeviceIntegrationPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_EglFSDeviceIntegrationPrivate_targets_file_included ON)
endif()
...
if (Qt6EglFSDeviceIntegrationPrivate_FOUND
    ...
    find_package(Qt6EglFSDeviceIntegrationPrivatePrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_EglFSDeviceIntegrationPrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::EglFSDeviceIntegrationPrivate)
    ...
    if(NOT DEFINED Qt6EglFSDeviceIntegrationPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_EglFSDeviceIntegrationPrivate_skip_include_targets_file)
            string(APPEND Qt6EglFSDeviceIntegrationPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_EglFSDeviceIntegrationPrivate_skip_include_targets_file being set to TRUE and thus "
