...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6RepParserTargetsPrecheck.cmake")

if(NOT __qt_RepParser_skip_include_targets_file AND Qt6RepParser_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6RepParserExtraProperties.cmake"
        OPTIONAL)
    set(__qt_RepParser_targets_file_included ON)
endif()
...
if (Qt6RepParser_FOUND
    ...
    find_package(Qt6RepParserPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_RepParser_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::RepParser)
    ...
    foreach(extra_cmake_include Qt6RepParserTransitiveExtras.cmake)
    ...
    if(NOT DEFINED Qt6RepParser_NOT_FOUND_MESSAGE)
        ...
        if(__qt_RepParser_skip_include_targets_file)
            string(APPEND Qt6RepParser_NOT_FOUND_MESSAGE
                "Possibly due to __qt_RepParser_skip_include_targets_file being set to TRUE and thus "
