...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6AxBasePrivateTargetsPrecheck.cmake")

if(NOT __qt_AxBasePrivate_skip_include_targets_file AND Qt6AxBasePrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6AxBasePrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_AxBasePrivate_targets_file_included ON)
endif()
...
if (Qt6AxBasePrivate_FOUND
    ...
    find_package(Qt6AxBasePrivatePrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_AxBasePrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::AxBasePrivate)
    ...
    if(NOT DEFINED Qt6AxBasePrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_AxBasePrivate_skip_include_targets_file)
            string(APPEND Qt6AxBasePrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_AxBasePrivate_skip_include_targets_file being set to TRUE and thus "
